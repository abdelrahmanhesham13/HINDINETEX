...
public class ShortNoteActivity extends AppCompatActivity implements SubjectAdapter.OnItemClick {
    ...
    private ArrayList<String> topicsTableSize;
    private ProgressBar progressBar;
    private TextView textView;
    private AdView mAdView;
    InterstitialAd mInterstitialAd;
    AdRequest adRequest2;
    private static final String subjectUrl = "https://sheets.googleapis.com/v4/spreadsheets/14c072l7A6mYt3lM61zAI5YGj4bmdvoQA_nSAq4SWUcM/values/SHORT%20NOTES%20NAME!A:N?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";
    private static final String topicUrl = "https://sheets.googleapis.com/v4/spreadsheets/14c072l7A6mYt3lM61zAI5YGj4bmdvoQA_nSAq4SWUcM/values/SHORT%20NOTES%20TOPIC%20NAME!A:N?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_short_note);
        setTitle("HINDI NETEX");
        ...
        topicsAdapter = new TopicsAdapter(topics, new TopicsAdapter.OnItemClick() {
            ...
            public void setOnItemClick(int position) {
                Intent intent = new Intent(ShortNoteActivity.this, ShortNoteDetailsActivity.class);
                intent.putExtra("selectedTopicId", topics.get(position).getTopicId());
                intent.putExtra("selectedTopicTableSize",topicsTableSize.get(position));
                ...
                try {
                    ...
                    for (int i = 1; i < jsonArray.length(); i++) {
                        ...
                        if (topicStatue.equals("ACTIVE") && subjectId.equals(selectedSubjectId)) {
                            topicsTableSize.add(jsonArray1.getString(5));
