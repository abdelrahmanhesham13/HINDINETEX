...
public class MCQActivity extends AppCompatActivity implements SubjectAdapter.OnItemClick {
    ...
    private static final String subjectUrl = "https://sheets.googleapis.com/v4/spreadsheets/14c072l7A6mYt3lM61zAI5YGj4bmdvoQA_nSAq4SWUcM/values/SUBJECT%20NAME%20MCQ!A:B?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";
    private static final String topicURL = "https://sheets.googleapis.com/v4/spreadsheets/14c072l7A6mYt3lM61zAI5YGj4bmdvoQA_nSAq4SWUcM/values/MCQ%20TOPIC%20NAME!A:E?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topicsAdapter = new TopicsAdapter(topics, new TopicsAdapter.OnItemClick() {
            ...
            public void setOnItemClick(int position) {
                Intent intent = new Intent(MCQActivity.this, QuizActivity.class);
                intent.putExtra("selectedTopicId", topics.get(position).getTopicId().trim());
    ...
    public void setOnItemClick(int position) {
        ...
        topics.clear();
        selectedSubjectId = String.valueOf(selectedSubject.getSubjectId()).trim();
            ...
            if (jsonResponse != null) {
                try {
                    ...
                    for (int i = 1; i < jsonArray.length(); i++) {
                        ...
                        if (topicStatue.equals("ACTIVE") && subjectId.trim().equals(selectedSubjectId)) {
