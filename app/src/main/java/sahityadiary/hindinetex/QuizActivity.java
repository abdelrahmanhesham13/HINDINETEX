...
public class QuizActivity extends AppCompatActivity {
    ...
    private static final String quizUrl = "https://sheets.googleapis.com/v4/spreadsheets/14c072l7A6mYt3lM61zAI5YGj4bmdvoQA_nSAq4SWUcM/values/MCQ%20QUIZ%20SETS!A:E?key=AIzaSyAHRy3U0-UXRMxVJ09ubzT66KCmPeKkC98";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedTopicId = intent.getStringExtra("selectedTopicId").trim();
            ...
            if (jsonResponse != null) {
                try {
                    ...
                    for (int i = 1; i < jsonArray.length(); i++) {
                        ...
                        String quizTime = jsonArray1.getString(4);
                        if (topicId.trim().equals(selectedTopicId)) {
